...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => 'admin'], function () {
    ...
    Route::get('products', 'PurchaseOrderController@getProductsList')->name('products');
    Route::get('products/{id}', 'PurchaseOrderController@getProductsShow')->name('products.show');
    Route::get('products/{id}/edit', 'PurchaseOrderController@getProductsEdit')->name('products.edit');
    Route::get('products/{id}/destroy', 'PurchaseOrderController@getProductsDestroy')->name('products.destroy');
...
Route::get('tes/2fa', 'MembershipController@index')->name('membership')->middleware(['auth', '2fa']);